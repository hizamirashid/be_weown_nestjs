...
import {CallStatus, Platform, RegisterMethod, RegisterStatus, UserPrivacyTypes, UserRole} from "../../../core/utils/enums";
import {VersionsService} from "../../../api/versions/versions.service";
import {MeetService} from "../../../chat/call_modules/meet/meet.service";
...
export class FirstRunService {
    ...
    private async _closeAllCalls() {
        await this.meetService.updateMany(
            {$or: [{callStatus: CallStatus.Ring}, {callStatus: CallStatus.InCall}]},
            {$set: {callStatus: CallStatus.SessionEnd}}
        );
    }
